...
- **Hub mode toggle**: hub endpoints live inside `refractive_swan_api`; disable with `refractive_swan_API_ENABLE_HUB=false` if running a standalone hub surface later.
