...
- `refractive_swan_pipeline::PipelineExecution` surfaces a per-run `PipelineMetrics` snapshot that downstream apps can merge/log via `refractive_swan_observability::log_pipeline_output_with_summary`, avoiding ad-hoc recounting of AutoMapped/NeedsReview/NoMatch totals.
